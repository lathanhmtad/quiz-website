...
(
    ...
    updated_date           	datetime              	null,
    updated_by           	bigint                	null,
	constraint pk_participant_answer primary key (id)
);
alter table participant_answer
	add constraint fk_participant_answer_on_participant_id foreign key (participant_id) references participant(id);
alter table participant_answer
	add constraint fk_participant_answer_on_answer_id foreign key (answer_id) references answer(id);
