...
create table participant_question_answer
(
	id 						bigint auto_increment 	not null,
	participant_id 			bigint					not null,
    question_id				bigint					not null,
    ...
    updated_date           	datetime              	null,
    updated_by           	bigint                	null,
	constraint pk_participant_question_answer primary key (id)
);
alter table participant_question_answer
	add constraint fk_participant_question_answer_on_participant_id foreign key (participant_id) references participant(id);
alter table participant_question_answer
	add constraint fk_participant_question_answer_on_question_id foreign key (question_id) references question(id);
